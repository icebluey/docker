...
cd "${_tmp_dir}"
wget -q -c -t 9 -T 9 \
'https://github.com/icebluey/docker/releases/download/v2024-12-20/containerd-1.7.24-1_amd64.tar.xz'
wget -q -c -t 9 -T 9 \
'https://github.com/icebluey/docker/releases/download/v2024-12-20/docker-only-27.4.1-1_amd64.tar.xz'
