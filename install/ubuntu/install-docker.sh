...
cd "${_tmp_dir}"
wget -q -c -t 9 -T 9 \
'https://github.com/icebluey/docker/releases/download/v2025-05-24/docker-only-28.1.1-1_amd64.tar.xz'
wget -q -c -t 9 -T 9 \
'https://github.com/icebluey/docker/releases/download/v2025-05-24/containerd-2.1.1-1_amd64.tar.xz'
