...
cd "${_tmp_dir}"
wget -q -c -t 9 -T 9 \
'https://github.com/icebluey/docker/releases/download/v2025-04-29/containerd-1.7.27-1_amd64.tar.xz'
wget -q -c -t 9 -T 9 \
'https://github.com/icebluey/docker/releases/download/v2025-04-29/docker-only-28.1.1-1_amd64.tar.xz'
